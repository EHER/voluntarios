...
class Version20141227033829 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Entidade (id INT AUTO_INCREMENT NOT NULL, cidade_id INT DEFAULT NULL, nome VARCHAR(50) NOT NULL, endereco VARCHAR(50) NOT NULL, cep VARCHAR(9) NOT NULL, bairro VARCHAR(50) NOT NULL, telefone VARCHAR(50) NOT NULL, site VARCHAR(200) NOT NULL, email VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_1A5F84849586CC8 (cidade_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
