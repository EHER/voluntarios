...
use Eher\QueroSerVoluntario\Bundle\DomainBundle\Entity\Vaga;
use Eher\QueroSerVoluntario\Bundle\DomainBundle\Form\VagaType;
...
class VagaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $repository = $entityManager->getRepository('EherQueroSerVoluntarioDomainBundle:Vaga');
        ...
        return $this->render('EherQueroSerVoluntarioAdminBundle:Vaga:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EherQueroSerVoluntarioAdminBundle:Vaga:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $entityManager->getRepository('EherQueroSerVoluntarioDomainBundle:Vaga')->find($id);
        ...
        return $this->render('EherQueroSerVoluntarioAdminBundle:Vaga:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EherQueroSerVoluntarioAdminBundle:Vaga:edit.html.twig', array(
            'entity'      => $entity,
